...
{   
    ...
    public ArrayList<Coordenada> resolverRuta(ArrayList<Coordenada> lstpuntos, Coordenada destino, int cuadranteorigen, int cuadrantedestino)
    {
        ...
        /*Si ealcanza menos del limite se resuelve por el metodo de fuerza bruta, si no se fragmentara de manera infinita hasta satisfacer el limite*/
        if(lstpuntos.size() <= limite)
        {
            return br.start(lstpuntos, destino);
        }else 
        {
            return resolverCuadrante(lstpuntos,cuadranteorigen,cuadrantedestino);
        }
    }
    ...
    public ArrayList<Coordenada> resolverCuadrante(ArrayList<Coordenada> lstpuntos,int cuadranteorigen, int cuadrantedestino)
    {
        ...
        /*Debido a que se conectan al final los 4 cuadrantes sin relacionarse y el primer punto es el origen se crea unos puntos intermedios para 
        verificar la cercania que hay en el eje X o Y dependiendo de la cuadrante, el mas cercano se convierte en el primer punto*/           
        ...
        /*Despues de preparar dichos parametros se llama otra ves al metodo resolverruta en cada cuadrante, el resultado se añadira a la lista total, 
        cabe decir que este cambio de metodos de resolverRuta y resolverCuadrante se pueden llegar a repetir hasta el infinito, hasta que satisfaga el limite*/             
        for(int l = 0; l < 4; l++)
        {
